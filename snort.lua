...
-- HOME_NET = 'any' <- COMMENTED IT OUT
HOME_NET = '10.1.100.0/4' --ADDED HERE
...
data_log = { key = 'http_request_header_event', } --added from extra check params
dpx = { } --extra default enabled
stream = { }
stream_ip = { }
stream_icmp = { }
stream_tcp = { }
...
port_scan = default_low_port_scan -- THIS WAS default_med_port_scan
smtp = default_smtp
...
ips =
{
    ...
    --include = '/home/rumasi/Desktop/what.rules'--ADDED HERE
